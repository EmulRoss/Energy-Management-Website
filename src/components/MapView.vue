...
export default {
  mounted() {
    ...
    Vue.http
      .get("http://127.0.0.1:5000/daily/heatmap/")
      .then(
        response => {
          // get body data
            ...
            if (feature.properties && feature.properties.popupContent) {
              ...
              layer.on("click", function(event) {
                ...
                if (CurrentCheck[1] == " No Data") {
                  ...
                  document.getElementById("myChart").style.visibility =
                    "hidden";
                  document.getElementById("PieChart").style.visibility =
                    "hidden";
                } else {
                  document.getElementById("h101").innerHTML =
